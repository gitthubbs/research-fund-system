...
\abstract[Abstract]
% ==== 随机文本，使用模板时请替换\item 之后的内容
{\lipsum[2-3]}
% ==== 英文创新点
\begin{innovation}[Innovation]
    \item \lipsum[3][1]
    \item \lipsum[3][2-3] 
    \item \lipsum[3][4-6] 
\end{innovation}
% ==== 英文关键词
\keywords[Keywords]{Curricula Knowledge; Construction; Constructivism; Social Constructivism; Individual Constructivism}