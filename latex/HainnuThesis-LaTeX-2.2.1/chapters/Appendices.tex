...
\begin{table}[htp]
	...
	\begin{tabular}{|l|l|l|}
		\hline
		接口路径          & 请求方式   & 功能说明         \\ \hline
		/api/projects/list   & GET       & 分页获取当前用户管控的项目列表      \\ \hline
		/api/statistics/summary & GET    & 获取全校/个人经费执行多维统计看板   \\ \hline
		/api/budget/check      & POST      & 预检报销申请是否符合预算余额要求   \\ \hline
		/api/risk/tags         & GET       & 根据偏差模型动态生成项目智能风险标签 \\ \hline
	\end{tabular}
\end{table}
