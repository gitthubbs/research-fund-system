...
\begin{table}[hbp]
    ...
    \begin{tabular}{|C{.35\textwidth}|C{.2\textwidth}|C{.14\textwidth}|C{.09\textwidth}|C{.0715\textwidth}|}
        \hline
        \textbf{文章名称} & \textbf{发表刊物(出版社)} & \textbf{刊发时间} & \textbf{刊物级别} & \textbf{第几作者} \\ \hline
