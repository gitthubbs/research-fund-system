...
\caption{期刊网站上下载BibTeX文件}
\label{ref-infor-not-complete}
\end{figure}

\red{警告: 从期刊官网或百度学术搜素上下载的BibTeX文件信息通常不完整，需要自己补全或利用AI工具自动补全。务必注意AI工具不是万能的，请注意检查核对AI输出的结果。虚假文献危害很大，请务必注意避免给自己和导师
带来不必要的损失！}
...
\begin{table}[htp]
	...
	\begin{tabular}{:l:c:c:}
		\Xhline{1.5pt}
		功能          &WEB         &APP         \\ \Xhline{1pt}
		注册          &$\surd$     &$\surd$     \\ \hdashline
		登录          &$\surd$     &$\surd$     \\ \hdashline
		推送          &$\times$    &$\surd$     \\ \Xhline{1.5pt}
	\end{tabular}
\end{table}
...
\begin{table}[htp]
	...
	\centering
	\begin{tabular*}{0.75\textwidth}{:l:c:c:}
		\Xhline{1.5pt}
		功能          &WEB         &APP         \\ \Xhline{1pt}
		注册          &$\surd$     &$\surd$     \\ \hdashline
		登录          &$\surd$     &$\surd$     \\ \hdashline
...
\Xhline{1.5pt}
\diagbox{节次}{\rotatebox{-45}{课程}}{星期} & 星期一 & 星期二 & 星期三 & 星期四 & 星期五 & 星期六 \\ \Xhline{1pt}
上午 1-2 &  经济学  &  量子力学  &  微波原理 &  编译原理 & 计数组合学 & 学术讲座 \\ \hdashline
上午 3-4 &  微波原理 & 学术写作  &  计数组合学& 经济学   & 民法典专题  & 学术讲座       \\ \Xhline{1.5pt}
\end{tabular}
\end{table}

\subsection{复杂表格}

去网站~\url{https://www.tablesgenerator.com/latex_tables}看看，你肯定会喜欢的!更改好表格的数据后，点击Generate即可生成\LaTeX 代码！ 2025年以来，利用AI自动处理表格是很时髦的，你可以试试看！

\subsection{支持自动添加表头的换页表格}
如表~\ref{tab4}~所示.
\begin{center}
	\begin{longtable}{:c:p{1.5cm}:c:p{2cm}:}
		\caption{某个用于测试的表格} \label{tab4} \\
		\Xhline{1.5pt}
		\textbf{$x$}& \textbf{$\sin x$} & \textbf{$5x^{2}+3x+3$}& \textbf{$\log_{10}x$}\\ \Xhline{1pt}
		\endfirsthead
		\caption*{某个用于测试的表格(续)}\\
		\Xhline{1.5pt}
		\textbf{$x$}& \textbf{$\sin x$} & \textbf{$5x^{2}+3x+3$}& \textbf{$\log_{10}x$}\\ \Xhline{1pt}
		...
		\Xhline{1.5pt}
		\endlastfoot
		1.00 & 0.02 & 11.00 & 0.00\\ \hdashline
		2.00 & 0.03 & 29.00 & 0.30\\ \hdashline
		3.00 & 0.05 & 57.00 & 0.48\\ \hdashline
		4.00 & 0.07 & 95.00 & 0.60\\ \hdashline
		5.00 & 0.09 & 143.00 & 0.70\\ \hdashline
		6.00 & 0.10 & 201.00 & 0.78\\ \hdashline
		7.00 & 0.12 & 269.00 & 0.85\\ \hdashline
		8.00 & 0.14 & 347.00 & 0.90\\ \hdashline
		9.00 & 0.16 & 435.00 & 0.95\\ \hdashline
		10.00 & 0.17 & 533.00 & 1.00\\ \hdashline
		11.00 & 0.19 & 641.00 & 1.04\\ \hdashline
		12.00 & 0.21 & 759.00 & 1.08\\ \hdashline
		13.00 & 0.22 & 887.00 & 1.11\\ \hdashline
		14.00 & 0.24 & 1025.00 & 1.15\\ \hdashline
		15.00 & 0.26 & 1173.00 & 1.18\\ \hdashline
		16.00 & 0.28 & 1331.00 & 1.20\\ \hdashline
		17.00 & 0.29 & 1499.00 & 1.23\\ \hdashline
		18.00 & 0.31 & 1677.00 & 1.26\\ \hdashline
		19.00 & 0.33 & 1865.00 & 1.28\\ \hdashline
		20.00 & 0.34 & 2063.00 & 1.30\\ \hdashline
...
\tablehead{\Xhline{1.5pt} $x$ & $\sin x$ & $5x^{2}+3x+3$ & $\log_{10}x$ \\ \Xhline{1pt}}
\tablecaption{另一种跨页表格}
\tabletail{\Xhline{1.5pt}}
\begin{center}
...
\label{tab5}
	\begin{supertabular}{:c:c:c:c:}
		...
		19.00 & 0.33 & 1865.00 & 1.28\\ \hdashline
		20.00 & 0.34 & 2063.00 & 1.30\\ \hdashline
		21.00 & 0.36 & 2271.00 & 1.32\\ \Xhline{1.5pt}
	\end{supertabular}
\end{center}
...
\begin{verbatim}
	...
	\end{landscape}
\end{verbatim}
进行设定。需要注意的是，横置的表格会占用至少一页的空间。一个小例子如下所示。
	\begin{landscape}
	\begin{table}
		\centering
		\caption{一个横着放的小表格}
		\begin{tabular}{:c:c:c:p{2cm}:p{2cm}:}
			\Xhline{1.5pt}
			Aqqq & Bqqq & Cqqq & Dqqq & Eqqqqq \\ \Xhline{1pt}
			1 & 2 & 3 & 4 & 5\\ \hdashline
			A & B & C & D & E \\ \hdashline
			1 & 2 & 3 & 4 & 5\\ \hdashline
			A & B & C & D & E \\ \hdashline
...
这里有一个长表格，也横置了，很占地方呀！
\begin{landscape}
		\begin{longtable}{:c:m{4cm}:c:c:p{4cm}:c:}
		\caption{某个用于测试的表格} \label{tab4} \\
		\Xhline{1.5pt}
		$x$ & $\sin x$ & $\cos x$ & $5x^{2}+3x+3$ & $\log_{10}x$ & $3x+5$\\ \Xhline{1pt}
		\endfirsthead
		\caption*{某个用于测试的表格(续)}\\
		\Xhline{1.5pt}
		$x$ & $\sin x$ & $\cos x$ & $5x^{2}+3x+3$ & $\log_{10}x$ & $3x+5$\\ \Xhline{1pt}
		...
		\Xhline{1.5pt}
		\endlastfoot
		1.00 & 0.02 & 1.00 & 11.00 & 0.00 & 8.00\\ \hdashline
		2.00 & 0.03 & 1.00 & 29.00 & 0.30 & 11.00\\ \hdashline
		3.00 & 0.05 & 1.00 & 57.00 & 0.48 & 14.00\\ \hdashline
		4.00 & 0.07 & 1.00 & 95.00 & 0.60 & 17.00\\ \hdashline
		5.00 & 0.09 & 1.00 & 143.00 & 0.70 & 20.00\\ \hdashline
		6.00 & 0.10 & 0.99 & 201.00 & 0.78 & 23.00\\ \hdashline
		7.00 & 0.12 & 0.99 & 269.00 & 0.85 & 26.00\\ \hdashline
		8.00 & 0.14 & 0.99 & 347.00 & 0.90 & 29.00\\ \hdashline
		9.00 & 0.16 & 0.99 & 435.00 & 0.95 & 32.00\\ \hdashline
		10.00 & 0.17 & 0.98 & 533.00 & 1.00 & 35.00\\ \hdashline
		11.00 & 0.19 & 0.98 & 641.00 & 1.04 & 38.00\\ \hdashline
		12.00 & 0.21 & 0.98 & 759.00 & 1.08 & 41.00\\ \hdashline
		13.00 & 0.22 & 0.97 & 887.00 & 1.11 & 44.00\\ \hdashline
		14.00 & 0.24 & 0.97 & 1025.00 & 1.15 & 47.00\\ \hdashline
		15.00 & 0.26 & 0.97 & 1173.00 & 1.18 & 50.00\\ \hdashline
		16.00 & 0.28 & 0.96 & 1331.00 & 1.20 & 53.00\\ \hdashline
		17.00 & 0.29 & 0.96 & 1499.00 & 1.23 & 56.00\\ \hdashline
		18.00 & 0.31 & 0.95 & 1677.00 & 1.26 & 59.00\\ \hdashline
		19.00 & 0.33 & 0.95 & 1865.00 & 1.28 & 62.00\\ \hdashline
		20.00 & 0.34 & 0.94 & 2063.00 & 1.30 & 65.00\\ \hdashline
		21.00 & 0.36 & 0.93 & 2271.00 & 1.32 & 68.00\\ \hdashline
		22.00 & 0.37 & 0.93 & 2489.00 & 1.34 & 71.00\\ \hdashline
		23.00 & 0.39 & 0.92 & 2717.00 & 1.36 & 74.00\\ \hdashline
		24.00 & 0.41 & 0.91 & 2955.00 & 1.38 & 77.00\\ \hdashline
		25.00 & 0.42 & 0.91 & 3203.00 & 1.40 & 80.00\\ \hdashline
		26.00 & 0.44 & 0.90 & 3461.00 & 1.41 & 83.00\\ \hdashline
		27.00 & 0.45 & 0.89 & 3729.00 & 1.43 & 86.00\\ \hdashline
		28.00 & 0.47 & 0.88 & 4007.00 & 1.45 & 89.00\\ \hdashline
		29.00 & 0.48 & 0.87 & 4295.00 & 1.46 & 92.00\\ \hdashline
		30.00 & 0.50 & 0.87 & 4593.00 & 1.48 & 95.00\\ \Xhline{1.5pt}
	\end{longtable}
\end{landscape}
\newpage 
...
\begin{itemize}
\item[\ding{172}] 期刊论文, 例如\cite{XmDeng2007,Brown1984,ZHY2017RS,ZHY2012manifold}以及\cite{Wing2006CT,ZhangHY2025KuiperHOE}
