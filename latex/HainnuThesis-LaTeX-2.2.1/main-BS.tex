...
\hainnuset{%
	% -- 中文信息                        % 论文题目↓↓↓
	title         = {基于多维数据分析的高校项目经费决策支持系统的设计与实现},
	...
	type		      = {论文},	%文档类型：论文/设计, 因人而已，请与指导教师确认
	% -- 英文信息                        % 论文题目(英文)↓↓↓
...
\begin{document}
	...
	\include{chapters/Design}            %第4章 总体设计
	\include{chapters/Implementation}    %第5章 核心功能实现
\include{chapters/Testing}           %第6章 系统测试
\include{chapters/Conclusion}        %第7章 结论与展望
